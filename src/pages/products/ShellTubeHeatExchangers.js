      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          <nav className="mb-8">
            ...
            <span className="text-gray-700">{t('nav.products_sub.shell_tube_heat_exchangers')}</span>
          </nav>
          <h1 className="text-4xl font-bold text-center mb-6">{t('products.shellTubeHeatExchangers.title')}</h1>
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto">
            {t('products.shellTubeHeatExchangers.subtitle')}
          </p>
        </div>
      </section>
