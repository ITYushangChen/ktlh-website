...
const SteelPipes = () => {
  ...
  return (
    <div className="py-8 pb-16 bg-white">
      <ProductCategorySeo categoryId="steel-pipes" path="/products/steel-pipes" />
      <section className="bg-white py-8">
        <div className="container mx-auto px-4">
          <nav className="text-sm mb-8">
            ...
            <span className="text-gray-700">{t('nav.products_sub.steel_pipes')}</span>
          </nav>
