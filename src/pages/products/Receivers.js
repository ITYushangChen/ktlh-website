    ...
    <div className="py-16">
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-gray-600 text-center max-w-3xl mx-auto">{t('products.receivers.subtitle')}</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg text-gray-600 mb-8">{t('products.receivers.overview')}</p>
            ...
            {items.map((product) => (
              <div key={product.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div className="relative overflow-hidden">
                  <img src={product.image} alt={gl(product.name)} className="w-full h-48 object-cover hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="p-6">
                    ...
                    <div className="space-y-1">
                      {Object.entries(product.specifications || {}).map(([key, val]) => (
                        <div key={key} className="flex justify-between text-sm">
                          <span className="text-gray-600">{t(`products.receivers.specLabels.${key}`, key)}:</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={key} className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">{t(`products.receivers.applications.${key}`)}</h3>
                <p className="text-gray-600">{t(`products.receivers.applications.${key}Desc`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-[#086c7b]">
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">{t('products.professionalSupport')}</p>
